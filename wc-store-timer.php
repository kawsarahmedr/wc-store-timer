<?php
/**
 * Plugin Name:  WC Store Timer
 * Description:  TBD.
 * Version:      1.0.0
 * Plugin URI:   https://pluginever.com/plugins/woocommerce-store-timer/
 * Author:       PluginEver
 * Author URI:   https://pluginever.com/
 * Text Domain:  wc-store-timer
...
use WooCommerceStoreTimer\Plugin;
 ...
 * @return Plugin
 */
function wc_store_timer() { // phpcs:ignore
	$data = array(
		'file'         => __FILE__,
		'settings_url' => admin_url( 'admin.php?page=wc-store-timer' ),
